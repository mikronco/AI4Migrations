...
class Maple():
    ...
    def run_all(self):
        ...
        x = self.params["X_test"][self.params["instance"],:].reshape(1, -1)
        nfeat = len(self.params["X_test"][self.params["instance"],:])
        retain, X = self.fit()
        ...
        print("\n")
        print("#################################")
        print_instance(self.params["X_test"][self.params["instance"],:], self.params["features"], self.params["instance"])
        print("#################################")
        print("\n")
